...
func (ydbCluster *YandexDBCluster) atomicTransferBasic(
	...
	return ydbCluster.ydbConnection.Table().DoTx(ctx,
...
func (ydbCluster *YandexDBCluster) MakeAtomicTransfer(
	...
	if ydbCluster.transferUseMagic {
		return ydbCluster.atomicTransferMagic(ctx, transfer, amount, transferId)
	}

	return ydbCluster.atomicTransferBasic(ctx, transfer, amount, transferId)
}
